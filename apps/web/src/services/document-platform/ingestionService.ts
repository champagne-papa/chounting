...
//
// INV-SERVICE-001 wrap-site discipline: ingestionService methods are
...
//   - handleForwardedMailbox(input, ctx) — mail webhook entry point;
//     adds the `forwarded_mailbox` branch to the channel_metadata Zod
//     discriminated union; composes the same 5-table write via the
//     same chunk 6.1 RPC.
//
...
import { DragDropUploadInputSchema } from '@/shared/schemas/document-platform/ingestBatch.schema';
import type {
  DragDropUploadInput,
