...
## Push-readiness gate (floor-only carve-out, sixth invocation)
...
**N=6 invocation context.** Session 6's execution push will be the sixth floor-only invocation (after halftime plans push N=1, 5A brainstorm push N=2, 5B brainstorm closeout push N=3, Session 6 brainstorm dispatch push N=4, 5B execution push N=5). 5B execution push (N=5) is the first execution-grade fire of the carve-out; Session 6 execution push (N=6) is the second. N=6 with the formal-criteria-primary justification (not "brainstorm pushes are special") confirms the formal criteria operate uniformly across brainstorm-grade plan-and-closeout work AND execution-grade README-rewrite work. Codification of the carve-out itself defers to Session 7's natural substrate moment per substrate-now-enforcement-later — Session 6 uses the carve-out, does not codify it.
...
**Context:** Push-readiness gate per Topic 5 lock: floor-only carve-out, formal criteria as primary justification, N=6 fire. Verification protocol matches the carve-out's framing — floor-scope only, full-suite NOT invoked per the mechanical-non-impact argument.
...
- 2026-05-XX NOTE — Round-2 docs reorganization Session 6
  ...
  - Tier 1 LIVE: floor-only push gate carve-out advances N=5 LIVE
    → N=6 LIVE this push. Codification position for Session 7
    strengthens further; formal-criteria-primary justification
    confirmed across both brainstorm-grade and execution-grade
    work (5B execution push N=5 was the first execution-grade
    fire; Session 6 execution push N=6 is the second). Other
  ...
  - Floor-only carve-out at N=6 LIVE goes to Session 7 for
...
Floor-only push gate carve-out advances N=5 LIVE → N=6 LIVE.
...
execution-grade README-rewrite work (5B execution push N=5 is
the first execution-grade fire; this push N=6 is the second). Codification deferred to
...
scope (Turbo cache, floor-only at N=6, count-level commit
...
- **Floor-only carve-out N=6 invocation** is one of the closeout-entry-significant observations; capture explicitly in the friction-journal entry per Task 3 Step 2's structure. Codification of the carve-out itself defers to Session 7 — Session 6 uses, doesn't codify.
