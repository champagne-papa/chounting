...
> **Version history:** v0.1.0 → v0.5.6. Full changelog with each version's
> findings and resolutions in `docs/prompt-history/CHANGELOG.md`. Current
> version: **v0.5.6** (step-5 split: Part 2 → `docs/specs/phase-1.1.md`,
> CLAUDE.md derived, ADR-001 written).
