...
12. **Schema-decision discipline held — zero new platform-owned columns.** ADR-0014 introduced zero new columns to platform-owned tables (source_documents, source_document_versions, document_artifacts, ocr_runs, extraction_runs). Reserved org_settings.* columns ship at v1 schema time per ADR-0010 discipline; they are not platform-table additions. Schema-decision discipline, per ADR-0013's original_storage_key precedent, held during C5 drafting.
...
Disposition summary: 8 ratify-as-is (notes 1, 4, 7, 9, 10, 11, 12, 13), 2 CTO calls (notes 3 + 8), 1 ratify-with-named-follow-up (note 5), 2 future-notes (notes 2 + 6). Sums to 13.
